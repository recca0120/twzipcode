...
class Normalizer
{
    ...
    public static function county()
    {
        ...
        return new static(preg_replace('/^'.implode('|', $map).'/u', function ($m) use ($map) {
            return $map[$m[1]];
        }, strtr($this->address, [
            '台北' => '臺北',
            '台南' => '臺南',
    ...
    public static function district()
    {
        ...
        return new static(strtr($this->attribute, $map));
    }
    ...
    public function street()
    {
        ...
        if (preg_match('/'.implode('|', $pattern).'/', $address) != false) {
            return new static(strtr($address, $map));
        }
